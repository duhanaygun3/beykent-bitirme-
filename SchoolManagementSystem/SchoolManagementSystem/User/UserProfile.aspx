<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMst.Master" AutoEventWireup="true" CodeBehind="UserProfile.aspx.cs" Inherits="SchoolManagementSystem.User.UserProfile" %>
        ...
        <div class="col-md-6">        
            <div class="row mb-3 mr-lg-5 ml-lg-5">
                <div class="col-md-3 col-md-offset-2 mb-3">
                    <asp:Button ID="btnUpdate" runat="server" CssClass="btn btn-primary btn-block" BackColor="#007F00" Text="Güncelle" OnClick="btnUpdate_Click" />
                </div>
            </div>
